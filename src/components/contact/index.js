...
export default function Contact() {
    ...
    const queryFormSubmit = (e) => {
        e.preventDefault();
        axios("http://127.0.0.1:5000/add/query", {
            method: "POST",
            data: {
                "client_name": name,
                "client_email": email,
                ...
                <Box>
                    <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
                        ...
                        <Box
                            ...
                            <form onSubmit={(e) => { queryFormSubmit(e); }}>
                                ...
                                <VStack spacing={5}>
                                    <FormControl isRequired>
                                        ...
                                        <InputGroup>
                                            ...
                                            <Input onChange={e => setName(e.target.value)} required type="text" name="name" placeholder="Your Name" />
                                        </InputGroup>
                                    </FormControl>
